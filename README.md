...
- High performance  
When the NumPy implementation on the M2 MacBook Air processed 33 tokens/s, while the CUDA version processed 2,823 tokens/s on a NVIDIA 4080 SUPER, which is about 100 times faster. This experiment really showed us why we should use GPU.
